...
var reducer = (state = {count: 1}, action) => {
  switch(action.type){
    case 'INC': return {count: state.count + 1}
    case 'DEC': return {count: state.count > 1 ? state.count - 1 : 1}
...
const totalPrice = (state.count * pricePerItem).toFixed(3)
              ...
              <View style = {{
                ...
                justifyContent : 'space-between'
                  ...
                  <View style = {{flexDirection: 'row', alignItems: 'center', marginBottom: 20}}>
                      ...
                      <Text style = {{fontSize: 15, marginHorizontal: 20}} >{state.count}</Text>
